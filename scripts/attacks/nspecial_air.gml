...
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_SFX_FRAME, 22);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_WINDOW_CREATION_FRAME, 24);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_LIFETIME, 8);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITBOX_X, 70);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITBOX_Y, 0);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_WIDTH, 100);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HEIGHT, 120);
...
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_HIT_SFX, sound_get("needle_2"));
