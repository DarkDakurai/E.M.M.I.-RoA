...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_WINDOW_CREATION_FRAME, 18);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_LIFETIME, 5);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITBOX_X, 110);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITBOX_Y, -76);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_WIDTH, 65);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HEIGHT, 65);
